...
export const itineraryData: DayItinerary[] = [
  ...
  },
  {
    ...
    spots: [
      {
        name: "酒店出发 → 大皇宫",
        desc: "从暹罗区酒店出发，BTS到Saphan Taksin站转乘湄南河快船（Chao Phraya Express Boat）到Tha Chang码头，沿途欣赏湄南河两岸风光",
        time: "07:30-08:30",
        icon: "fa-ship",
        img: "https://images.unsplash.com/photo-1559592413-7cec4d0cae2b?w=600&q=80",
        tips: "坐船去大皇宫是最有仪式感的方式！橙旗船15泰铢/人，到N9 Tha Chang码头下船。一定要8:30前到大皇宫，避开旅行团大军",
      },
      {
        name: "大皇宫 + 玉佛寺",
      ...
      {
        name: "回酒店休整 → 换装",
        desc: "坐船回Saphan Taksin再转BTS回酒店，洗澡换衣服，准备晚上的夜市之旅。曼谷的夜晚才是真正的开始！",
        time: "17:30-19:00",
        icon: "fa-hotel",
        img: "https://images.unsplash.com/photo-1508009603885-50cf7c579365?w=600&q=80",
      },
    ...
    transport: "BTS + 湄南河快船(15泰铢) + 摆渡船(4泰铢) + MRT",
    budget: 800,
  },
  {
    day: 8,
    ...
    spots: [
      {
        ...
        desc: "东南亚最大的周末市场，超过15000个摊位分成27个区！从手工艺品、vintage服饰、泰丝、椰子碗、香薰精油到各种小吃应有尽有。这里是买伴手礼的终极战场",
        time: "09:00-12:30",
        icon: "fa-shop",
        img: "https://images.unsplash.com/photo-1555529669-e69e7aa0ba9a?w=600&q=80",
        tips: "BTS Mo Chit站或MRT Chatuchak Park站。一定要9点开门就到，中午后人挤人！必逛：Section 2-4（手工艺品）、Section 7（泰裤/棉麻衣服）、Section 17-19（家居香薰）。带现金砍价，开价的6-7折起砍",
      },
      {
        name: "暹罗商圈购物",
        desc: "回到暹罗区逛三大商场：Siam Paragon（奢侈品+B1层暹罗海洋世界）、CentralWorld（中档品牌最全）、MBK Center（平价购物砍价天堂）。商场里冷气十足，是中午避暑的最佳选择",
        time: "13:30-16:00",
        icon: "fa-bag-shopping",
        img: "https://images.unsplash.com/photo-1519451241324-20b4ea2c4220?w=600&q=80",
        tips: "BTS Siam站直达。推荐在CentralWorld 7楼的After You吃招牌蜜糖吐司（Shibuya Honey Toast 295泰铢），泰奶刨冰也超好吃！Boots和屈臣氏买泰国本土护肤品（Snail White蜗牛霜、Mistine防晒）超划算",
      },
      {
        name: "建兴酒家 Somboon Seafood",
        desc: "曼谷最有名的咖喱蟹餐厅！由潮汕华人黄汉坚老先生创立，招牌咖喱炒蟹用新鲜斯里兰卡蟹配上浓郁的蛋黄咖喱酱，是来曼谷必吃的一道菜。还有冬阴功虾、蒜蓉粉丝蒸扇贝",
        time: "16:30-18:00",
        icon: "fa-shrimp",
        img: "https://images.unsplash.com/photo-1559847844-5315695dadae?w=600&q=80",
        tips: "推荐Siam Square One分店（BTS Siam站），或Central Embassy分店。咖喱蟹约800-1200泰铢/只（按重量），4人点一只蟹+2-3个菜够吃。建议16:30去避开排队高峰",
      },
      {
        name: "Divana Nurture Spa",
        desc: "CNN评选曼谷最佳六大泰式按摩之一！隐藏在素坤逸小巷里的精品SPA会馆，环境像热带花园一样美。招牌Nurture套餐包含泰式草药热敷+精油按摩，旅途最后的极致放松",
        time: "18:30-20:30",
        icon: "fa-spa",
        img: "https://images.unsplash.com/photo-1544161515-4ab6ce6db874?w=600&q=80",
        tips: "地址：Sukhumvit Soi 25，BTS Asok站步行10分钟。2小时套餐约2500-3500泰铢/人，建议提前1天在官网预约。比街边按摩贵但体验完全不同级别",
      },
      {
        name: "Octave Rooftop Bar",
        desc: "曼谷最适合闺蜜拍照的高空酒吧！位于Marriott Sukhumvit酒店45-49楼，360度无遮挡全景俯瞰曼谷夜景。分三层：45楼室内酒吧、48楼露天平台、49楼最高层。四个人在星空下举杯，为9天旅程画上最美的句号",
        time: "21:00-23:00",
        icon: "fa-champagne-glasses",
        img: "https://images.unsplash.com/photo-1470337458703-46ad1756a187?w=600&q=80",
        tips: "BTS Thong Lo站步行5分钟。无低消但鸡尾酒约350-500泰铢/杯。17:00开始营业，21:00后氛围最好。穿漂亮裙子来！49楼风很大但夜景最震撼，记得带外套",
      },
      {
        name: "回酒店收拾行李",
        desc: "最后的曼谷夜晚，回酒店整理行李、称重、分装伴手礼。凌晨01:25的红眼航班，需要22:30前到机场，所以23:00前必须从酒店出发",
        time: "23:00-23:30",
        icon: "fa-suitcase",
  ...
  },
  {
    ...
    spots: [
      {
        name: "酒店 → 素万那普机场",
        desc: "从暹罗区酒店出发前往素万那普国际机场。深夜打车最方便，Grab约250-350泰铢，车程40-50分钟。提前3小时到机场办理值机和退税",
        time: "23:30-00:30",
        icon: "fa-taxi",
        img: "https://images.unsplash.com/photo-1544620347-c4fd4a3d5957?w=600&q=80",
        tips: "深夜Airport Rail Link已停运（末班车约24:00），打Grab最稳妥。记得留200泰铢现金付机场行李车费。退税柜台在4楼出发层",
      },
      {
        name: "机场免税店 · 最后扫货",
