...
{
day: 6,
label: '5.7 飞抵曼谷·ICONSIAM',
title: '飞抵曼谷·ICONSIAM河畔购物',
color: '#e07a5f',
img: '/map-bangkok-day6.png',
spots: 3,
desc: '素万那普机场→Grab约40分钟→ICONSIAM暹罗天地（Sook Siam室内水上市场+河畔购物）',
},
{
day: 7,
label: '5.8 金碧辉煌·寺庙巡礼',
...
spots: 8,
desc: '码头上船→大皇宫+玉佛寺→卧佛寺→Supanniga河景午餐→郑王庙→TYME Rooftop日落→Jodd Fairs夜市',
},
{
day: 8,
label: '5.9 铁道奇观·水上集市',
